...
from src.fits.observation_extractor import extract_observation
from src.utils.fs import clear_diagnostics_dir, compute_file_hash
...
from src.storage.db_introspection import (
    _ensure_and_insert,
    record_exists, 
...
from src.fits.processing_fit import populate_row
from src.utils.invalid_path_registry import _validate_symlink

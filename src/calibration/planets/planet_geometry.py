...
import numpy as np
from src.config.constants import (ARCSEC_TO_RAD, AU_TO_KM, 
                                  JUPITER_MEAN_DIAMETER_KM)
from src.calibration.ephemeris.jpl_horizons_table import (
    load_jpl_horizons_table)
from src.calibration.errors import (
...
def add_jupiter_distance_au(row: Dict[str, Any], log: logging.Logger
    ...
    """
    try:
        ang_diam_arcsec = float(row["PLANET_ANG_DIAM"])
